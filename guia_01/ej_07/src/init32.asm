...
init32:
    ...
    mov esi, __TAREA_1_LMA                   ;Puntero al inicio de la LMA
    mov edi, __TAREA_1_VMA                   ;Puntero a VMA
    mov ecx, __TAREA_1_VMA_END    
    sub ecx, __TAREA_1_VMA                   ;Tamaño a copiar
    rep movsb 
